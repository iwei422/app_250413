...
# 左側：選單欄
name = st.sidebar.selectbox("### 請選擇分類模型：",
                             ("KNN",
                              "LogisticRegression",
                              "SVM",
                              "RandomForest"))
...
s2 = st.slider("花萼長度：",1.5,5.5,4.0)
s3 = st.slider("花萼長度：",0.6,7.5,4.0)
s4 = st.slider("花萼長度：",0.05,3.5,2.0)
